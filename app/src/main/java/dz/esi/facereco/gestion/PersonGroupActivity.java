package dz.esi.facereco.gestion;
...
import dz.esi.facereco.outils.StorageHelper;
...
public class PersonGroupActivity extends AppCompatActivity {
        ...
        protected String doInBackground(String... params) {
            ...
            try{
                ...
                faceServiceClient.createLargePersonGroup(
                        params[0],
                        getString(dz.esi.facereco.R.string.user_provided_person_group_name),
                        getString(dz.esi.facereco.R.string.user_provided_person_group_description_data));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(dz.esi.facereco.R.layout.activity_person_group);
        ...
        EditText editTextPersonGroupName = (EditText)findViewById(dz.esi.facereco.R.id.edit_person_group_name);
    ...
    private void initializeGridView() {
        ...
        gridView.setMultiChoiceModeListener(new AbsListView.MultiChoiceModeListener() {
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                ...
                inflater.inflate(dz.esi.facereco.R.menu.menu_delete_items, menu);
                ...
                Button addNewItem = (Button)findViewById(dz.esi.facereco.R.id.add_person);
            ...
            public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                switch (item.getItemId()) {
                    case dz.esi.facereco.R.id.menu_delete_items:
                        deleteSelectedItems();
                        return true;
                    default:
                        return false;
    ...
    private class PersonGridViewAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = layoutInflater.inflate(dz.esi.facereco.R.layout.item_person, parent, false);
            }
            ...
            if (!faceIdSet.isEmpty()) {
                ...
                ((ImageView)convertView.findViewById(dz.esi.facereco.R.id.image_person)).setImageURI(uri);
            } else {
                Drawable drawable = getResources().getDrawable(dz.esi.facereco.R.drawable.select_image);
                ((ImageView)convertView.findViewById(dz.esi.facereco.R.id.image_person)).setImageDrawable(drawable);
            }

            // set the text of the item
            String personName = StorageHelper.getPersonName(personId, personGroupId, PersonGroupActivity.this);
            ((TextView)convertView.findViewById(dz.esi.facereco.R.id.text_person)).setText(personName);

            // set the checked status of the item
            CheckBox checkBox = (CheckBox) convertView.findViewById(dz.esi.facereco.R.id.checkbox_person);
            if (longPressed) {
